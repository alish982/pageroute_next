...
function Success({ showPopup, setShowPopup }) {
    ...
    return(
        ...
        <button onClick = {handleClick} className="absolute top-0 right-0 rounded-md p-2 inline-flex items-center justify-center hover:bg-gray-100 ">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
              </svg>
            </button>
            <div className = "p-2" > 
              <Image className = "mt-1" src= {showPopup.statusCode === 200 ? "/success.png" : "/failed.png"} alt = "" height = "31" width = "31"/>
            </div>
            <div className = "p-2">
